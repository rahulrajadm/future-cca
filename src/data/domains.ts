...
export interface Domain {
  id: DomainId
  name: string
  /** Approximate proportion of scored items drawn from this domain, per the exam blueprint. */
  weight: number
...
export function getTaskStatement(domain: DomainId, code: string): TaskStatement | undefined {
  return DOMAIN_MAP[domain]?.taskStatements.find((t) => t.code === code)
}
